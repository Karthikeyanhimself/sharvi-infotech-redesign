            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 bg-white/5 px-4 py-2 rounded-xl border border-white/5">
              <div className="flex items-center gap-1.5">
                ...
                <a
                  ...
                  className="font-italianno text-xl sm:text-2xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 hover:brightness-125 transition-all pl-1"
                >
                  Karthikeyan
                </a>
              </div>
